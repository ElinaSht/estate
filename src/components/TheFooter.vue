    ...
    <div class="bg-black-gray w-full h-[406px] sm:max-md:h-[300px] max-sm:h-max">
      <div class="max-w-[1304px] px-4 mx-auto pt-[70px] text-white flex justify-between lg:max-xl:pt-[50px] max-lg:pt-[30px] max-sm:pb-[30px] max-sm:flex-col max-sm:gap-6">
        <div class="max-w-[300px] flex flex-col sm:max-lg:max-w-[220px] sm:max-md:max-w-[180px] max-sm:mx-auto max-sm:items-center">
          <img class="w-[216px] pt-[8px] sm:max-lg:w-[180px] max-md:w-[150px]" alt="ElcorePLC" src="../assets/logo.svg" />
          ...
          <div
            class="w-[155px] h-[46px] border-[1px] flex gap-2.5 border-gray-dark-4 rounded cursor-pointer
                   hover:scale-110 transition sm:max-md:w-[120px] max-sm:self-center max-sm:w-full max-sm:justify-center max-sm:hover:scale-100"
          >
...
C
          <div class="flex flex-col gap-[26px] sm:max-md:gap-[18px]">
            <button
              class="h-[47px] px-[17px] border-[1px] border-white rounded text-white font-bold text-[18px] hover:border-green-logo hover:text-green-logo transition max-lg:text-[12px] max-sm:h-[38px] max-sm:hover:scale-100">
              Личный кабинет
            </button>
